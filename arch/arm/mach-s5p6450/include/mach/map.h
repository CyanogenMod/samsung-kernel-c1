...
#define S5P6450_PA_PDMA		0xE9000000
...
#define S5P6450_PA_RTC		(0xEA100000)
#define S3C_PA_RTC		S5P6450_PA_RTC
...
#define S5P_VA_UART04(x)	(S3C_VA_UART + ((x) * S5P_UART_OFFSET))
#define S5P_VA_UART5		S3C_VA_UART5

#define S5P_VA_UARTx(x)		(((x) > 4) ? S5P_VA_UART04(x) : S5P_VA_UART5)
...
/* GPS APB */
#define S5P6450_PA_GPS	   	(0xEC900000)
#define S5P_PA_GPS	   	S5P6450_PA_GPS
#define S5P_SZ_GPS		SZ_256

#define S5P6450_PA_HSOTG	(0xED100000)
#define S5P_PA_OTG		S5P6450_PA_HSOTG
#define S5P_SZ_OTG		SZ_1M

#define S5P6450_PA_OTGSFR	(0xED200000)
#define S5P_PA_OTGSFR		S5P6450_PA_OTGSFR
...
#define S5P6450_PA_MSHC		(0xED500000)
...
/* I2S */
#define S5P6450_PA_I2S		0xF2000000

/* PCM */
#define S5P6450_PA_PCM		0xF2100000
...
#define S3C_PA_WDT		S5P6450_PA_WDT
#define S5P_PA_MSHC		S5P6450_PA_MSHC

#define SAMSUNG_PA_ADC		S5P6450_PA_ADC
