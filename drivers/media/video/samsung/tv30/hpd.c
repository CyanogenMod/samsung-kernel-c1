...
extern void s5p_hdmi_clear_pending(enum s5p_hdmi_interrrupt intr);
extern void s5p_hdmi_enable_interrupts(enum s5p_hdmi_interrrupt intr);
extern void s5p_hdmi_disable_interrupts(enum s5p_hdmi_interrrupt intr);
...
static int __init s5p_hpd_probe(struct platform_device *pdev)
{
	...
	s5p_hdmi_register_isr((hdmi_isr) s5p_hpd_irq_handler, (u8)HDMI_IRQ_HPD_PLUG);
	s5p_hdmi_register_isr((hdmi_isr) s5p_hpd_irq_handler, (u8)HDMI_IRQ_HPD_UNPLUG);
